...
{{--                            <?php dd($list);?>--}}
                        <tr>
                            ...
                            <td class="text-center"><a style="color:#333333;font-weight: bold;" href="#" style="white-space:unset;text-align: justify;">{{$item->ten}}<i class="fa fa-edit"></i></a></td>
                            ...
                            <td class="text-center"><img id="mat_truoc_preview"
                                                         src="{{ $item->anh?''.Storage::url($item->anh):'http://placehold.it/100x100' }}"
                                                         alt="your image"
                                                         style="max-width: 200px; height:100px; margin-bottom: 10px;" class="img-responsive"/>
                            </td>
                            <td class="text-center">{{$item->id_dia_chi}}</td>
