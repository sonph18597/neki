            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    <li class=" active menu-open ">
                        <a href="../Shoes"><i class="fa fa-user"></i> <span>Shoes</span></a>
                        <ul class="treeview-menu">
                            <li><a href=""><i class="fa fa-circle-o"></i> Shoes</a></li>
                        </ul>
                        <a href="../DiscountCode"><i class="fa fa-user"></i> <span>Discout Code</span></a>
                        <ul class="treeview-menu">
                            <li><a href=""><i class="fa fa-circle-o"></i> Discout Code</a></li>
                        </ul>
                    </li>
                </ul>
            </section>
